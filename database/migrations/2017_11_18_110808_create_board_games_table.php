    ...
    private function getGames()
    {
        ...
        return [
            ...
            [
                "name" => "Канагава",
                "description" => "
                    Kanagawa – очень красивая настольная игра, наполненная умиротворенной восточной атмосферой. Хорошо подойдет для уютного семейного вечера за чашечкой чая или в компании друзей. Несомненно, понравится любителям пособирать карточные сеты, поклонникам живописи, и японской культуры. Участникам настольной игры Kanagawa выпадет честь посещать уроки Хокусая, а после, применять полученные знания на холстах. И как знать, возможно, ученикам удастся превзойти учителя. Художник, написавший самое гармоничное полотно, станет победителем игры.  
                ",
                "type" => 2,
                "number_of_players" => "2-4",
                "age" => "от 10+",
                ...
                "language" => "Языконезависимая",
                "image" => "kanagawa.jpg",
                "tesera_url" => "http://tesera.ru/game/Kanagawa/",
                "youtube_url" => "https://www.youtube.com/embed/VJnwXLqfpnk",
                "created_at" => $now,
                "updated_at" => $now
            ],
            [
                "name" => "Kingdomino",
                "description" => "
                    Kingdomino – великолепная семейная игра, в которой удачно сочетается стратегическое планирование ходов, логика и элемент случайности. Здесь постоянно присутствует дефицит нужных доминошек и чтобы победить, необходимо иметь хладнокровие и умение успешно применять правило гамбита: проиграть сопернику пешку, чтобы выиграть королеву. Правила игры объясняются за считанные минуты, а сыграв одну партию, всегда возникает желание продолжить.  
                ",
                "type" => 2,
                "number_of_players" => "2-4",
                "age" => "от 8+",
                ...
                "tesera_url" => "http://tesera.ru/game/824784/",
                "youtube_url" => "https://www.youtube.com/embed/PQGkWGmXbUw",
                "created_at" => $now,
                "updated_at" => $now
            ],
        ];
